...
CREATE TABLE
  testQuestion (id serial PRIMARY KEY, question TEXT NOT NULL);

CREATE TABLE
  testQuestionPhone (id serial PRIMARY KEY, question TEXT NOT NULL);
...
INSERT INTO
  reportedPhoneNumbers (phone_number, freetext)
VALUES
  ('077-8137813', 'Använde kivra');

INSERT INTO
  reportedLinks (link, freetext)
VALUES
  ('www.scam.com', 'internetbedrägeri');

INSERT INTO
  testResults (user_id, suspect_details, result)
VALUES
  (1, '077-8137813', 13);

INSERT INTO
  wallPosts (free_text, phone_number, severity)
VALUES
  (
    'Svara inte på detta numret!!!',
    '077-8137813',
    'red'
  ),
  ...
  (
    'Påstår sig komma från Kivra nr2',
    '08-121212',
    'orange'
  );
